...
import pt.iscte.paddle.pandion.figures.ObjectContainer;
import pt.iscte.paddle.pandion.figures.PandionJFigure;
import pt.iscte.paddle.pandion.figures.StackContainer;
...
//	public void setInput(IRuntimeModel model) {
...
//			if(event.type == IRuntimeModel.Event.Type.NEW_STACK)
//				rebuildStack(model);
//			else if(event.type == IRuntimeModel.Event.Type.REMOVE_FRAME) {
...
//				}
//			}
//			else if(event.type == IRuntimeModel.Event.Type.NEW_FRAME) {
...
//	private void rebuildStack(IRuntimeModel model) {
//		clear();
