...
import pt.iscte.paddle.pandion.figures.ArrayPrimitiveFigure;
import pt.iscte.paddle.pandion.figures.ArrayReferenceFigure;
import pt.iscte.paddle.pandion.figures.IllustrationBorder;
import pt.iscte.paddle.pandion.figures.ObjectFigure;
import pt.iscte.paddle.pandion.figures.PandionJFigure;
import pt.iscte.paddle.pandion.figures.ReferenceFigure;
import pt.iscte.paddle.pandion.figures.ValueExtensionFigure;
import pt.iscte.paddle.pandion.figures.ValueFigure;
...
public class FigureProvider  {
	...
	FigureProvider(IRuntimeModel runtime) {
		assert runtime != null;
	...
	private PandionJFigure<?> createFigure(IObservableModel<?> model, boolean findExtensions) {
		...
		if(model instanceof IValueModel) {
			...
			Set<ITag> tags =  ImmutableSet.of(); // getEntityTags(entity);
			ITag tag = null;
			if(!tags.isEmpty())
