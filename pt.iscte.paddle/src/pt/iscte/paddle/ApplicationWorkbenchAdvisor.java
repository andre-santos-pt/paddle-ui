...
public class ApplicationWorkbenchAdvisor extends WorkbenchAdvisor {
	...
	private static final String PERSPECTIVE_ID = "pt.iscte.paddle.perspective"; //$NON-NLS-1$
...
//		Bundle ideBundle = Platform.getBundle(IDEWorkbenchPlugin.IDE_WORKBENCH);
		Bundle ideBundle = Platform.getBundle("pt.iscte.paddle");
		declareWorkbenchImage(configurer, ideBundle, IDE.SharedImages.IMG_OBJ_PROJECT, "icons/eclipse16.png", true);
