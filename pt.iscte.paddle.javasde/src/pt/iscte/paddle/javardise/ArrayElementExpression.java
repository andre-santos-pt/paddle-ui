...
public class ArrayElementExpression extends EditorWidget implements Expression {
	...
	public ArrayElementExpression(EditorWidget parent, String varId, String exp) {
		this(parent, varId, p -> new SimpleExpressionWidget(p, exp));
	}
	
	public ArrayElementExpression(EditorWidget parent, String varId, Expression.Creator f) {
		super(parent);
		...
		rightBracket.addKeyListener(new KeyAdapter() {
			public void keyPressed(KeyEvent e) {
				...
				if(op != null) {
					...
					((Expression) parent).substitute(ArrayElementExpression.this, b);
					b.focusRight();
				}
			}
		});
