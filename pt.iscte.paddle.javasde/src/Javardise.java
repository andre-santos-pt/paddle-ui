...
public class Javardise {
	private File file;
	private ClassWidget classWidget;

	public Javardise(File file) {
		this.file = file;
	}
	...
	public void launch() {
		...
		proc.getBody().addAssignment(param, IType.INT.literal(3));
...
//				System.out.println("compilation success");
	...
	public static void main(String[] args) {
		if(args.length == 0) {
			System.err.println("Please provide a file or directory as argument.");
			return;
		}

		File file = new File(args[0]);
		if(!file.exists()) {
			System.err.println("The provided argument is not a file or directory.");
			return;
		}
		...
		Javardise editor = new Javardise(file);
		editor.launch();
	}
